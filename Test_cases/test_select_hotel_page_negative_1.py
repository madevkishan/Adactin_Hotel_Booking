...
class TestSelecthHotel:

    def test_select_hotel(self,setup_browser):
        """
        ...
        selecthotel_obj.verifyerrormsg()
        error_text = selecthotel_obj.verifyerrormsg()

        error_msg = 'Please Select a Hotel'
