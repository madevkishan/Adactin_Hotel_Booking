...
class BookHotelPageActions:
    ...
    def enter_creditcard_num(self):
        ...
        creditcardnum_we.send_keys("53657766566")
    ...
    def enter_cvv_num(self):
        ...
        :return:
        """
        cvvnum_we = self.driver.find_element(By.NAME, self.book_loc_obj.cvv_loc_txt_xpath)
        # cvvnum_we.clear()
        cvvnum_we.send_keys("123")
    ...
    def click_booknow(self):
        ...
        :return:
        """
        booknow_we = self.driver.find_element(By.XPATH, self.book_loc_obj.booknow_loc_btn_xpath)
        booknow_we.click()
